...
const Forgot = () => {
    ...
    return (
        <div className='w-screen min-h-screen lg:py-0 flex justify-center items-center'>
            <div className='lg:h-[70vh] w-[85vw] lg:w-[60vw] p-6 lg:p-8 rounded-xl ring-3 ring-[#792aea] bg-gradient-to-tr from-[#260e4d] to-[#6b22e1] shadow-[0px_0px_20px_8px_#792aea]'>
